...
void main() {
  group('Fase 0 — Diamond problem', () {
    test('listener de d é notificado exatamente uma vez ao escrever em a', () {
      ...
      final Computed<int> d = Computed<int>(() => b.value + c.value, name: 'd');
  ...
  group('Fase 0 — Computed que corta propagação', () {
    test('b recomputa mas não muda; nada downstream de b recomputa', () {
      final Observable<int> a = Observable<int>(1);
      int bRuns = 0;
  ...
  group('Fase 0 — Dependências dinâmicas em Computed', () {
    test('branch condicional troca de dependência sem leak nem notificação '
        'fantasma', () {
